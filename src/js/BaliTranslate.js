...
function transliterate(regexp_file, text) {
    ...
    for (var i = 0, j = 0; i < str.length; i++) {
        if (regexp_file[str[i]] && regexp_file["ᬃ"] === "r") { //jawa->latin
            if (str[i] === "ᬳ") { //ha
                if (i > 0 && (str[i - 1] === "ᭂ" || str[i - 1] === "ᬾ" || str[i - 1] === "ᬶ" || str[i - 1] === "ᬵ" || str[i - 1] === "ᬸ" || str[i - 1] === "ᬅ" || str[i - 1] === "ᬏ" || str[i - 1] === "-" || str[i - 1] === "ᬑ" || str[i - 1] === "ᬉ")) {
                    trans = trans.ganti(j, "h" + regexp_file[str[i]]);
                    j += 2;
                }
                if (i > 0 && (str[i - 1] === "꧊")) {
                    trans = trans.ganti(j, "H" + regexp_file[str[i]]);
                ...
                if (i > 0 && str[i - 1] === "ᬚ") {
                    if (i > 1 && str[i - 2] === "꧊") {
                        trans = trans.ganti3(j, "Za");
                    } else {
                        trans = trans.ganti3(j, "za");
                    }
                } else if (i > 0 && str[i - 1] === "ᬧ") {
                    if (i > 1 && str[i - 2] === "꧊") {
                        trans = trans.ganti3(j, "Fa");
                    } else {
                        trans = trans.ganti3(j, "fa");
                    }
                } else if (i > 0 && str[i - 1] === "ᬯ") {
                    if (i > 1 && str[i - 2] === "꧊") {
                        trans = trans.ganti3(j, "Va");
                    } else {
                        trans = trans.ganti3(j, "va");
                    }
                ...
                if (i > 0 && str[i - 1] === "꧊") {
                    if (str[i] === "ᭅ") {
                        trans = trans.ganti(j, "Qa");
                        j += 2;
                    } else if (str[i] === "ᬩ" || str[i] === "ᬪ") {
                        trans = trans.ganti(j, "Ba");
                        j += 2;
                    } else if (str[i] === "ᬘ" || str[i] === "ᬙ") {
                        trans = trans.ganti(j, "Ca");
                        j += 2;
                    } else if (str[i] === "ᬤ" || str[i] === "ᬥ") {
                        trans = trans.ganti(j, "Da");
                        j += 2;
                    } else if (str[i] === "ᬕ" || str[i] === "ᬖ") {
                        trans = trans.ganti(j, "Ga");
                        j += 2;
                    } else if (str[i] === "ᬚ" || str[i] === "ᬛ") {
                        trans = trans.ganti(j, "Ja");
                        j += 2;
                    } else if (str[i] === "ᬓ" || str[i] === "ᬔ") {
                        trans = trans.ganti(j, "Ka");
                        j += 2;
                    } else if (str[i] === "ᬮ") {
                        trans = trans.ganti(j, "La");
                        j += 2;
                    } else if (str[i] === "ᬫ") {
                        trans = trans.ganti(j, "Ma");
                        j += 2;
                    } else if (str[i] === "ᬦ" || str[i] === "ᬡ") {
                        trans = trans.ganti(j, "Na");
                        j += 2;
                    } else if (str[i] === "ᬧ" || str[i] === "ᬨ") {
                        trans = trans.ganti(j, "Pa");
                        j += 2;
                    } else if (str[i] === "ᬭ" || str[i] === "-") {
                        trans = trans.ganti(j, "Ra");
                        j += 2;
                    } else if (str[i] === "ᬲ" || str[i] === "ᬰ") {
                        trans = trans.ganti(j, "Sa");
                        j += 2;
                    } else if (str[i] === "ᬢ" || str[i] === "ᬣ") {
                        trans = trans.ganti(j, "Ta");
                        j += 2;
                    } else if (str[i] === "ᬯ") {
                        trans = trans.ganti(j, "Wa");
                        j += 2;
                    } else if (str[i] === "ᬬ") {
                        trans = trans.ganti(j, "Ya");
                        j += 2;
                    } else {
                        trans.ganti(j, regexp_file[str[i]]);
                        j += 3;
                    }
                ...
                if (i > 0 && str[i - 1] === "꧊") {
                    if (str[i] === "ᬗ") {
                        trans = trans.ganti(j, "Nga");
                        j += 3;
                    } else if (str[i] === "ᬜ" || str[i] === "-") {
                        trans = trans.ganti(j, "Nya");
                        j += 3;
                    } else if (str[i] === "ᬝ" || str[i] === "ᬞ") {
                        trans = trans.ganti(j, "Tha");
                        j += 3;
                    } else if (str[i] === "ᬟ" || str[i] === "ᬠ") {
                        trans = trans.ganti(j, "Dha");
                        j += 3;
                    } else {
                        trans.ganti(j, regexp_file[str[i]]);
                        j += 3;
